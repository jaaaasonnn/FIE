    ...
    <div style={{ backgroundColor: 'var(--cream)' }}>
      <div style={{ backgroundColor: 'var(--brown-dark)' }} className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold mb-2" style={{ color: 'var(--cream)', fontFamily: 'Playfair Display, serif' }}>
            Privacy Policy
          </h1>
      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        <div className="space-y-8 text-sm text-stone-700 leading-relaxed">
          {[
            ...
            <div key={title}>
              <h2 className="text-lg font-bold mb-2" style={{ color: 'var(--brown-dark)', fontFamily: 'Playfair Display, serif' }}>{title}</h2>
              <p>{body}</p>
            </div>
          ))}
        </div>
