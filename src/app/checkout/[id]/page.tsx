      ...
      <div className="min-h-screen flex items-center justify-center px-4" style={{ backgroundColor: 'var(--color-bg)' }}>
        <div className="max-w-md w-full text-center">
          ...
          <div className="p-5 rounded-2xl text-left mb-6 space-y-2"
            ...
            <p className="font-semibold text-sm" style={{ color: 'var(--color-text-primary)' }}>{MOCK_BOOKING.listing}</p>
            ...
            <form onSubmit={handlePay} className="space-y-6">
              ...
              {payMethod === 'MOMO' && (
                <div className="space-y-4 p-5 rounded-2xl border border-stone-200 bg-white">
                  ...
                  <div className="space-y-2">
                    <p className="text-xs text-[#6B645C]">Select your network</p>
                    <div className="space-y-2">
                  ...
                  <div>
                    <label className="text-xs text-[#6B645C] block mb-1">Your MoMo Number</label>
                    <input
                      type="tel"
              ...
              {payMethod === 'CARD' && (
                <div className="space-y-4 p-5 rounded-2xl border border-stone-200 bg-white">
                  ...
                  <div>
                    <label className="text-xs text-[#6B645C] block mb-1">Name on Card</label>
                    <input placeholder="Kwame Asante" value={cardName} onChange={(e) => setCardName(e.target.value)}
                      className="w-full p-3 rounded-xl border border-stone-200 text-sm focus:outline-none focus:border-amber-400" />
                  </div>
                  <div>
                    <label className="text-xs text-[#6B645C] block mb-1">Card Number</label>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="text-xs text-[#6B645C] block mb-1">Expiry (MM/YY)</label>
                    ...
                    <div>
                      <label className="text-xs text-[#6B645C] block mb-1">CVV</label>
                  ...
                  <div className="flex items-center gap-2 text-xs text-[#6B645C] p-3 rounded-xl bg-stone-50">
            ...
            <div className="sticky top-24 space-y-4">
              <div className="bg-white p-5 rounded-2xl border border-stone-100 shadow-sm">
                ...
                <div className="flex gap-3 mb-5">
                  ...
                  <div>
                    <p className="font-semibold text-sm" style={{ color: 'var(--color-text-primary)' }}>{MOCK_BOOKING.listing}</p>
                    <p className="text-xs text-[#6B645C]">Host: {MOCK_BOOKING.host}</p>
                    <p className="text-xs text-[#6B645C]">
